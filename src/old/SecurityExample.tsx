...
export const SecurityExample: React.FC = () => {
  ...
  const answers = [
    "Authentication requires a second factor",
    "The password is encrypted in transit",
    "The account enters lockdown mode",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            An attacker obtained a user's password.
            Why is MFA still effective? 🔒
          </div>
        </div>
        ...
        {revealed && (
          ...
          >
            ...
            >
              ...
              the attacker still needs a second
              factor such as an authenticator
              app or security key.
            </div>
          </div>
        )}
